...
{% raw %}
```liquid
{% include post-timeline.html posts=site.posts limit=5 %}
```
{% endraw %}
...
{% raw %}
```liquid
{% include post-timeline.html posts=site.news %}
```
{% endraw %}
...
{% raw %}
```liquid
{% include post-timeline.html posts=site.changelogs limit=20 %}
```
{% endraw %}
...
{% raw %}
```liquid
{% include post-timeline.html posts=site.portfolio limit=12 %}
```
{% endraw %}
