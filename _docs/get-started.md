...
Or you can start with one of the [template configs](https://github.com/PrimerPages/primer-pages-dev/tree/main/templates){: data-proofer-ignore='' } and copy/customize the profile that best matches your setup.
